            ...
            @if ($hasil && $data_penjualan)
                ...
                <div class="stats w-full shadow">
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-value text-green-500"><x-format-money :value="$hasil['total']"></x-format-money></div>
                    </div>
                </div>
                <div
                ...
                <div class="card bg-white shadow">
                    <div class="card-body">
                        ...
                        <div class="flex flex-col items-center space-y-3 justify-center mt-5">
                            <a href="{{ route('user.pemasaran-bisnis.index') }}" class="btn btn-primary">Isi Pemasaran
                                Bisnis</a>
                            <a href="{{ route('user.penjualan.index') }}" class="btn btn-primary">Lakukan Penjualan</a>
                        </div>
                    </div>
                </div>
            @endif
